...
$(_DIR_OUT)/$(LOCAL_MODULE).elf: $(USED_LIBS) $(USED_TASKS)
	$(CC_$(LOCAL_TARGET)) $(CFLAGS) $(CFLAGS_$(LOCAL_TARGET)) $(LDFLAGS_$(LOCAL_TARGET)) $(LOCAL_LDFLAGS) -o $@ -L$(@D) $(TASKS_FLAGS) $(LIBS_FLAGS)
...
upload_$(LOCAL_TARGET)_$(LOCAL_MODULE): $(_DIR_OUT)/$(LOCAL_MODULE).hex
	avrdude -F -V -c arduino -p ATMEGA328P -P $(AVRDUDE_PORT) -b 57600 -U flash:w:$<
endif
